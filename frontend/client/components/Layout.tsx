        ...
        <div className="p-4 border-b border-sidebar-border flex items-center gap-2">
          ...
          {!isCollapsed && (
            <div className="flex-1 min-w-0">
              <Link to="/dashboard" className="font-bold text-sm text-sidebar-foreground hover:text-primary transition-colors">LifeOps</Link>
            </div>
          )}
          <button
        ...
        <div className="flex-1 overflow-y-auto">
          {isCollapsed ? (
            <nav className="p-2 space-y-1">
              <NavItem to="/dashboard" icon={<Home size={18} className="text-primary" />} label="Home" collapsed />
              ...
              <div className="p-4 border-b border-sidebar-border">
                ...
                {isWorkspaceOpen && (
                  <nav className="space-y-1">
                    <NavItem to="/dashboard" icon={<Home size={18} className="text-primary" />} label="Home" />
            ...
            <DropdownMenuTrigger asChild>
              <button className="w-full flex items-center gap-3 px-2 py-2 hover:bg-sidebar-accent rounded-md transition-colors">
                <Avatar className="w-10 h-10 flex-shrink-0">
                  <AvatarFallback className="bg-gradient-to-br from-teal-400 to-teal-600 text-white font-bold">{initials}</AvatarFallback>
                </Avatar>
                {!isCollapsed && (
                  <>
